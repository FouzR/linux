...
static const uint32_t pogo_keymap_proto3[] = {
	...
	KEY(5, 3, KEY_ODIAERESIS),
	KEY(5, 4, KEY_L),
	KEY(5, 5, KEY_9),
	KEY(5, 6, KEY_J),
	KEY(5, 7, KEY_UDIAERESIS),
	...
	KEY(7, 7, KEY_N),
	KEY(7, 8, KEY_LEFTDOUBLEQUOTEMARK),
	KEY(7, 9, KEY_DOUBLELOWQUOTEMARK),
	KEY(7, 10, KEY_D),
	KEY(7, 11, KEY_GREATER),
	KEY(7, 12, KEY_LESS),
